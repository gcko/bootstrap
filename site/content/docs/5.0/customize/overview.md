...
1. Using Bootstrap [via package manager]({{< docsref "/getting-started/measured-style-guide#quick-start" >}}) so you can use and extend our source files.
...
For those who want to use the distribution files, review the [getting started page]({{< docsref "/getting-started/measured-style-guide" >}}) for how to include those files and an example HTML page. From there, consult the docs for the layout, components, and behaviors you'd like to use.
