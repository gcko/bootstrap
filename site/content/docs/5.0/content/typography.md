...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td><span class="h1">h1. Measured heading</span></td>
    </tr>
    <tr>
      <td>
        {{< markdown >}}`<h2></h2>`{{< /markdown >}}
      </td>
      <td><span class="h2">h2. Measured heading</span></td>
    </tr>
    <tr>
      <td>
        {{< markdown >}}`<h3></h3>`{{< /markdown >}}
      </td>
      <td><span class="h3">h3. Measured heading</span></td>
    </tr>
    <tr>
      <td>
        {{< markdown >}}`<h4></h4>`{{< /markdown >}}
      </td>
      <td><span class="h4">h4. Measured heading</span></td>
    </tr>
    <tr>
      <td>
        {{< markdown >}}`<h5></h5>`{{< /markdown >}}
      </td>
      <td><span class="h5">h5. Measured heading</span></td>
    </tr>
    <tr>
      <td>
        {{< markdown >}}`<h6></h6>`{{< /markdown >}}
      </td>
      <td><span class="h6">h6. Measured heading</span></td>
    </tr>
  </tbody>
</table>

```html
<h1>h1. Measured heading</h1>
<h2>h2. Measured heading</h2>
<h3>h3. Measured heading</h3>
<h4>h4. Measured heading</h4>
<h5>h5. Measured heading</h5>
<h6>h6. Measured heading</h6>
```

`.h1` through `.h6` classes are also available, for when you want to match the font styling of a heading but cannot use the associated HTML element.

{{< example >}}
<p class="h1">h1. Measured heading</p>
<p class="h2">h2. Measured heading</p>
<p class="h3">h3. Measured heading</p>
<p class="h4">h4. Measured heading</p>
<p class="h5">h5. Measured heading</p>
<p class="h6">h6. Measured heading</p>
{{< /example >}}

### Customizing headings

Use the included utility classes to recreate the small secondary heading text from Measured 3.
...
In Measured 5, we've enabled responsive font sizes by default, allowing text to scale more naturally across device and viewport sizes. Have a look at the [RFS page]({{< docsref "/getting-started/rfs" >}}) to find out how this works.
